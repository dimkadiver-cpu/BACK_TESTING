...
- Aggiungere la un menu di configurazione di modifica della polici slezionata, con posibilita di salvarlo, o creare uno nuovo
- Verfica automatica di del db slezionato per Multitraider e deve permette di selezionare qual trader usare per backtesting o tutti.
