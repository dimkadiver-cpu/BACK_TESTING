...
from src.signal_chain_lab.domain.results import EventLogEntry, ScenarioResult, TradeResult
...
def test_html_report_and_advanced_exports(tmp_path) -> None:
    ...
    html_path = write_scenario_html_report(results, per_policy, tmp_path / "scenario.html")
    ...
    assert "Backtest metrics" in report_text
