...
Nota: il sistema deve supportare sia chain complete con update, sia dataset dove esiste solo il segnale iniziale senza update successivi.
...
Nota:
- la sequenza eventi può contenere solo il `NEW_SIGNAL`
...
- supporto sia a chain con update sia a chain composte dal solo segnale iniziale
